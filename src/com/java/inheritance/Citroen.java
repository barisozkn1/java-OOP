...
public class Citroen extends Cars{  //Extends yardımıyla aşağıdaki kod blogu yerine kalıtım mantıgını kullanırız.
...
//	}
//	
//	public Citroen(long araba_id, String araba_adi, String araba_model, int araba_yasi, int lastik_sayisi,int ayna_sayisi) {
...
//		return "Citroen [araba_id=" + araba_id + ", araba_adi=" + araba_adi + ", araba_model=" + araba_model
